...
export default function CommandantReportForm() {
  ...
  if (isEdit && existing?.status !== 'draft') return (
    <div className="max-w-2xl mx-auto p-6 text-center">
      <p className="text-gray-600 mb-4">This report has been submitted and is no longer editable.</p>
      <button
    ...
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Statistics are automatically computed on submission.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <section className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
          <h3 className="font-semibold text-gray-800 border-b pb-2">Report Identification</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Field label="Period Start *">
              <input
                ...
                onChange={handleChange}
                className={`w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.reporting_period_start ? 'border-red-400' : 'border-gray-300'}`}
              />
            ...
            <Field label="Period End *">
              <input
                ...
                onChange={handleChange}
                className={`w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.reporting_period_end ? 'border-red-400' : 'border-gray-300'}`}
              />
        ...
        <section className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
          <h3 className="font-semibold text-gray-800 border-b pb-2">Commandant's Narrative</h3>
          ...
          <Field label="Overall Remarks" hint="Any other remarks or closing statements.">
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 text-sm bg-blue-700 text-white rounded-lg hover:bg-blue-800 disabled:opacity-50"
          >

...
from .models import User, Course, Class, Enrollment, Subject, Notice, Exam, ExamReport, Attendance, ExamResult, ClassNotice, ExamResultNotificationReadStatus, ExamAttachment, NoticeReadStatus,ClassNoticeReadStatus

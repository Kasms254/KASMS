...
from .models import (
    ...
    SessionAttendance, AttendanceSessionLog, ExamResultNotificationReadStatus, SchoolAdmin, School,SchoolMembership,Certificate, CertificateTemplate, CertificateDownloadLog, BiometricDevice, BiometricUserMapping
)
